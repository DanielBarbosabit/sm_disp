...
urlpatterns = [
    ...
    path(r'historico/', views.historico, name='historico'),
    path(r'historico_editar_dispenser/', views.historico_editar_dispenser, name='historico_editar_dispenser'),
    path(r'historico_excluir/', views.historico_excluir, name='historico_excluir'),
